...
- ติดตามการเปลี่ยนแปลงของ status-line ใน Codex ต้นทาง เพื่อให้สามารถยกเลิกการแพตช์ได้หากมีตัวเรนเดอร์แบบกำหนดเองที่ได้รับการสนับสนุนเข้ามา
- เพิ่มภาพหน้าจอเมื่อการ์ดในไดเรกทอรีปลั๊กอิน Codex พร้อมสำหรับการเผยแพร่

## การร่วมพัฒนา

ยินดีต้อนรับ issue และ pull request หลังจากเปลี่ยนเอาต์พุต HUD ให้รัน `npm test` และตัวตรวจสอบปลั๊กอิน Codex หลังจากเปลี่ยนเวอร์ชัน manifest ให้ติดตั้งปลั๊กอินโลคัลใหม่ด้วย `codex plugin add codex-hud@codex-hud`
