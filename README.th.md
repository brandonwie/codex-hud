...
[คุณสมบัติ](#คุณสมบัติ) · [เริ่มต้นใช้งานอย่างรวดเร็ว](#เริ่มต้นใช้งานอย่างรวดเร็ว) · [การตั้งค่า](#การตั้งค่า) · [Footer ของ Codex ที่แพตช์แล้ว](#ฟีเจอร์ทดลอง-แถบท้าย-codex-ที่ถูกแพตช์) · [โรดแมป](#โรดแมป)
