...
> เซกเมนต์ `5h` และ `7d` จะจับคู่กับหน้าต่าง rate-limit ของ Codex ตามความยาวของหน้าต่าง (300 และ 10080 นาทีตามลำดับ) ไม่ใช่ตามตำแหน่งใน payload — ฝั่งแบ็กเอนด์อาจรายงานหน้าต่างใดก็ได้ในช่องใดก็ได้ หรือรายงานเพียงหน้าต่างเดียว เซกเมนต์ที่หน้าต่างของมันหายไปจาก payload จะแสดง `?` (เช่น `5h:?`) แทนที่จะยืมค่าของอีกหน้าต่างมาแสดง
