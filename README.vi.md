...
**HUD workspace cho OpenAI Codex CLI — mặc định là một HUD nhiều dòng độc lập, kèm theo một status line nhỏ gọn, có màu (model, dự án, git, ngữ cảnh, mức sử dụng 5h/7d) sẽ trở thành footer trong TUI ở chế độ vá thử nghiệm.**
