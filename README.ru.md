...
Терминальный снимок компактного футера по умолчанию:
...
Запустите локально `node plugins/codex-hud/scripts/codex-hud.js --line --color`, чтобы увидеть тот же футер со стилями ANSI-цветов.
